...
const AddClass = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/add-class', formData, {
                headers: {
    ...
    return (
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                            ...
                            >
                                ...
                                {ageCategories.map(category => (
                                    <option key={category.ageCategoryID} value={category.ageCategoryID}>
                                        {category.ageCategoryName} - {category.type}
                                    </option>
                                ))}
                            </select>
                        </div>
                ...
                <a href="/admin/view-class" className="mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Back</a>
            </main>
            {openAlert && (
                <motion.div
