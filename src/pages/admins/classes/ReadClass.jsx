...
const ReadClass = () => {
    ...
    useEffect(() => {
        const fetchClassData = async () => {
            try {
                // Fetch class data
                const classResponse = await axios.get(`https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/read-class/${classID}`);
                ...
                // Fetch sport data
                const sportResponse = await axios.get('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/fetchSport');
                ...
                // Fetch term data
                const termResponse = await axios.get('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/fetchTerm');
                ...
                const ageCategoryResponse = await axios.get('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/classAgeCategory');
                ...
                // Fetch coach data
                const coachResponse = await axios.get('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/fetchCoach');
    ...
    return (
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                <a href="/admin/view-class" className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Back</a>
            </main>
        </div>
    );
};
