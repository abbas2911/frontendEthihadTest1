...
const AddAgeCategory = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/insertAgeCategory', {
                categoryName,
                type,
            }, {
                headers: {
            ...
            setAlertMessage('Successfully added Age Category');
            setAlertSeverity('success');
            setOpenAlert(true);

        } catch (error) {
            console.error('Failed to add Age Category:', error);
            setAlertMessage('Failed to add Age Category');
    ...
    return (
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-100">Add Age Category Form</h2>
                        <p className="text-xs mt-1 text-gray-400">Fill in all the fields to add an age category</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            {loading ? 'Adding Age Category...' : 'Add Age Category'}
                        </button>
                    </form>
                </motion.div>
