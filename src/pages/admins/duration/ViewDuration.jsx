...
const ViewDuration = () => {
    ...
    const fetchDurationData = async () => {
        try {
            const response = await axios.get('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/fetchDurationList');
    ...
    const renderActions = (duration) => (
        <div className="flex space-x-4">
            <Link to={`/admin/update-duration/${duration.durationID}`} className="text-blue-600 hover:text-blue-900">
        ...
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    ...
                    <div className="mb-4">
                        <Link to={`/admin/add-duration`} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                            + Add Duration
                        </Link>
                    </div>
                    <TableComponent
