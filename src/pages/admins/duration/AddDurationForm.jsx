...
const AddDurationForm = () => {
    ...
    useEffect(() => {
        const fetchSport = async () => {
            try {
                const response = await axios.get('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/fetchSport');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/insertDuration', {
                durationName,
                durationDescription,
                sportID,
                numberOfSessions,
