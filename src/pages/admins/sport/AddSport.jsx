...
const AddSport = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/admin/insertSport', {
                sport_name,
            }, {
                headers: {
            ...
            setAlertMessage('Successfully added Sport');
            setAlertSeverity('success');
            setOpenAlert(true);
         
        } catch (error) {
            console.error('Failed to add sport:', error);
            setAlertMessage('Failed to add sport');
    ...
    return (
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-100">Add Sport Form</h2>
                        <p className="text-xs mt-1 text-gray-400">Fill in all the fields to add a sport</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-100">Sport Name:</label>
                            <input
                                type="text"
                                value={sport_name}
                        ...
                        >
                            {loading ? 'Adding Sport...' : 'Add Sport'}
                        </button>
                    </form>
                </motion.div>
