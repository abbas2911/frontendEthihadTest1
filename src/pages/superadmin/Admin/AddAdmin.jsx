...
const AddAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://abbas-test-project-4dc6504935e5.herokuapp.com/api/superadmin/add-admin', {
                username,
                password,
                firstName,
                lastName,
    ...
    return (
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-100">Add Admin Form</h2>
                        <p className="text-xs mt-1 text-gray-400">Fill in all the fields to add an admin</p>
                    </div>
