...
const ViewStudent = () => {
    ...
    const renderActions = (student) => (
        <div className="flex space-x-4">
            <Link to={`/superadmin/read-student/${student.studentID}`} className="text-blue-600 hover:text-blue-900">
                <Eye className="w-5 h-5" />
            </Link>
            <Link to={`/superadmin/update-student/${student.studentID}`} className="text-blue-600 hover:text-blue-900">
                <Edit className="w-5 h-5" />
            </Link>
            <Link to={`/superadmin/update-sport/${student.studentID}`} className="text-blue-600 hover:text-blue-900">
        ...
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    ...
                    <div className="mb-4">
                        <Link to={`/superadmin/add-student`} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                            + Add Student
                        </Link>
                    </div>
                    <TableComponent
