    ...
    return (
        <div className="flex-1 overflow-auto relative z-10">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
                ...
                >
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-100">Update Item Form</h2>
                ...
                <a href="/superadmin/view-item" className="mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Back</a>
            </main>
            {openAlert && (
                <motion.div
